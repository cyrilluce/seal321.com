...
var logger = module.exports = isDev ? tracer.colorConsole(config) : tracer.console(config);

logger.delegate = function(...nsArgs){
    var host = this;
    var delegator = {};
    levels.forEach(level=>{
        delegator[level] = (...args)=>host[level].apply(host, nsArgs.concat(args));
    })
    return delegator;
};
